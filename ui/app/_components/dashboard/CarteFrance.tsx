...
import styles from "./carte-france.module.scss";

const defaultFillColor = "var(--background-default-grey)";
...
export function CarteFrance<K extends string, Data extends { [_key in K]: number }>(props: Props<K, Data>) {
  ...
  const bins = useMemo(
    ...
    [props.donneesAvecDepartement, props.dataKey, props.minColor, props.maxColor, props.pourcentage]
  );

  const donneesParDepartement = useMemo(
    () =>
      props.donneesAvecDepartement.reduce(
        (acc, v) => ({
          ...acc,
          [v.departement]: {
            ...v,
            color: (bins.find((bin) => v[props.dataKey] >= bin.minValue && v[props.dataKey] <= bin.maxValue) as Bin)
              ?.color,
          },
        }),
        {} as { [key: string]: Data & { color: string } }
      ),
    [props.donneesAvecDepartement, bins, props.dataKey]
  );

  const onMouseMove: MouseEventHandler = (event) => {
    const target = event.target as HTMLElement;
    const offset = 20;
    const donneesDepartement = donneesParDepartement[target.dataset?.numerodepartement as any];
    setTooltipInfos({
      ...
      content: (
        <>
          <span className={styles.tooltipTitle}>{target.dataset.nom}</span>
          {props.tooltipContent(donneesDepartement)}
        </>
      ),
    });
  };
  ...
  const onMouseOut: MouseEventHandler = () => {
    setTooltipInfos({ x: 0, y: 0, visible: false, content: <></> });
  };
  ...
  return (
    <div className={styles.wrapper}>
      <ul className={styles.legend}>
        {bins?.map((bin, i) => (
          <li key={i} className={styles.legendItem}>
            <span className={styles.legendDot} style={{ backgroundColor: bin.color }} aria-hidden="true" />
      ...
      <div className={styles.carte} onMouseMove={onMouseMove} onMouseOut={onMouseOut}>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 667 578">
          <g className="region region-01" data-nom="Guadeloupe" data-code_insee="01">
            <path
              ...
              fill={donneesParDepartement["971"]?.color ?? defaultFillColor}
          ...
          <g className="region region-02" data-nom="Martinique" data-code_insee="02">
            <path
              data-nom="Martinique"
              data-numerodepartement="972"
              fill={donneesParDepartement["972"]?.color ?? defaultFillColor}
          ...
          <g className="region region-03" data-nom="Guyane" data-code_insee="03">
            <path
              ...
              fill={donneesParDepartement["973"]?.color ?? defaultFillColor}
          ...
          <g className="region region-04" data-nom="La Réunion" data-code_insee="04">
            <path
              data-nom="La Réunion"
              data-numerodepartement="974"
              fill={donneesParDepartement["974"]?.color ?? defaultFillColor}
          ...
          <g className="region region-06" data-nom="Mayotte" data-code_insee="06">
            <path
              ...
              fill={donneesParDepartement["976"]?.color ?? defaultFillColor}
          ...
          <g className="region region-11" data-nom="Île-de-France" data-code_insee="11">
            <path
              ...
              fill={donneesParDepartement["75"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["77"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["78"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["91"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["92"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["93"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["94"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["95"]?.color ?? defaultFillColor}
          ...
          <g className="region region-24" data-nom="Centre-Val de Loire" data-code_insee="24">
            <path
              ...
              fill={donneesParDepartement["18"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["28"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["36"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["37"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["41"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["45"]?.color ?? defaultFillColor}
          ...
          <g className="region region-27" data-nom="Bourgogne-Franche-Comté" data-code_insee="27">
            <path
              ...
              fill={donneesParDepartement["21"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["25"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["39"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["58"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["70"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["71"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["89"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["90"]?.color ?? defaultFillColor}
          ...
          <g className="region region-28" data-nom="Normandie" data-code_insee="28">
            <path
              ...
              fill={donneesParDepartement["14"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["27"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["50"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["61"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["76"]?.color ?? defaultFillColor}
          ...
          <g className="region region-32" data-nom="Hauts-de-France" data-code_insee="32">
            <path
              ...
              fill={donneesParDepartement["02"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["59"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["60"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["62"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["80"]?.color ?? defaultFillColor}
          ...
          <g className="region region-44" data-nom="Grand Est" data-code_insee="44">
            <path
              ...
              fill={donneesParDepartement["08"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["10"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["51"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["52"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["54"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["55"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["57"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["67"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["68"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["88"]?.color ?? defaultFillColor}
          ...
          <g className="region region-52" data-nom="Pays de la Loire" data-code_insee="52">
            <path
              ...
              fill={donneesParDepartement["44"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["49"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["53"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["72"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["85"]?.color ?? defaultFillColor}
          ...
          <g className="region region-53" data-nom="Bretagne" data-code_insee="53">
            <path
              ...
              fill={donneesParDepartement["22"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["29"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["35"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["56"]?.color ?? defaultFillColor}
          ...
          <g className="region region-75" data-nom="Nouvelle-Aquitaine" data-code_insee="75">
            <path
              ...
              fill={donneesParDepartement["16"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["17"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["19"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["23"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["24"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["33"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["40"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["47"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["64"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["79"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["86"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["87"]?.color ?? defaultFillColor}
          ...
          <g className="region region-76" data-nom="Occitanie" data-code_insee="76">
            <path
              ...
              fill={donneesParDepartement["09"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["11"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["12"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["30"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["31"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["32"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["34"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["46"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["48"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["65"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["66"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["81"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["82"]?.color ?? defaultFillColor}
          ...
          <g className="region region-84" data-nom="Auvergne-Rhône-Alpes" data-code_insee="84">
            <path
              ...
              fill={donneesParDepartement["01"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["03"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["07"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["15"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["26"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["38"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["42"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["43"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["63"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["69"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["73"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["74"]?.color ?? defaultFillColor}
          ...
          <g className="region region-93" data-nom="Provence-Alpes-Côte d&#39;Azur" data-code_insee="93">
            <path
              ...
              fill={donneesParDepartement["04"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["05"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["06"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["13"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["83"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["84"]?.color ?? defaultFillColor}
          ...
          <g className="region region-94" data-nom="Corse" data-code_insee="94">
            <path
              ...
              fill={donneesParDepartement["2A"]?.color ?? defaultFillColor}
            ...
            <path
              ...
              fill={donneesParDepartement["2B"]?.color ?? defaultFillColor}
