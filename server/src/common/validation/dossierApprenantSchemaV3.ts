...
const dossierdossierApprenantSchemaV3BaseWithApiData = () => {
...
const dossierApprenantSchemaV3 = () => {
  return dossierdossierApprenantSchemaV3BaseWithApiData().superRefine((dossier, ctx) => {
    validateContrat(dossier, "", ctx);
    validateContrat(dossier, "_2", ctx);
    validateContrat(dossier, "_3", ctx);
    validateContrat(dossier, "_4", ctx);
  });
};
...
export type DossierApprenantSchemaV3BaseWithApiDataType = z.input<
  ReturnType<typeof dossierdossierApprenantSchemaV3BaseWithApiData>
>;
