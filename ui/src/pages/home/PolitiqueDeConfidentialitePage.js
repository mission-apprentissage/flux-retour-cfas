  ...
  return (
    <Page>
      <Section withShadow paddingY="4w">
        <BreadcrumbNav links={[NAVIGATION_PAGES.Accueil, NAVIGATION_PAGES.PolitiqueDeConfidentialite]} />
      </Section>
      <Section paddingY="4w">
        <HStack
          color="grey.800"
        ...
        >
          ...
          <Box>
            <Section pt="0">
              ...
              <Text>
                Le Tableau de bord de l’apprentissage est développé par la Mission nationale pour l’Apprentissage,
                mandatée par le ministère du Travail.
              </Text>
            </Section>
            <Section mt={4} id={currentPage.anchors.Finalite}>
              ...
              <UnorderedList marginLeft="30px !important" marginTop="1w">
                <ListItem>
                  Produire sous la forme d’un tableau de bord les données synthétiques des effectifs de
                  l&apos;apprentissage afin de contribuer au pilotage de l’apprentissage au niveau national et
                  territorial par les acteurs publics ou avec délégation de service public ;
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  Produire les données nécessaires aux organismes de formation pour répondre aux enquêtes (notamment
                  SIFA) ;
                </ListItem>
            ...
            <Section mt={4} id={currentPage.anchors.DonneesACaracterePersonelTraitees}>
              ...
              <UnorderedList marginLeft="30px !important" marginTop="1w">
                <ListItem>
                  Données relatives à l’identification du candidat ou jeune (nom, prénom, date de naissance, INE,
                  adresse e-mail) ;
                </ListItem>
                <ListItem>Données relatives au représentant légal du jeune (nom, numéro de téléphone) ;</ListItem>
                <ListItem>
                  Données relatives aux évènements du parcours des apprenants (date de début et de fin, date de début
                  fin de contrat, et rupture, organisme de formation et département) ;
                </ListItem>
            ...
            <Section mt={4} id={currentPage.anchors.BaseJuridiqueDuTraitementDeDonnees}>
              ...
              <Text>
                ...
                l’exercice de l’autorité publique dont est investi le responsable de traitement au sens de l’article 6-e
            ...
            <Section mt={4} id={currentPage.anchors.DroitDesPersonnesConcernees}>
              ...
              <Text>
                ...
                – ces éléments sont indispensables pour nous permettre de retrouver votre recherche – par voie
                ...
                la preuve de votre identité. <br />
            ...
            <Section mt={4} id={currentPage.anchors.DestinatairesDesDonnees}>
              ...
              <Text>
                Nous nous engageons à ce que les données à caractères personnels soient traitées par les seules
              ...
              <UnorderedList marginLeft="30px !important" marginTop="1w">
                ...
                <ListItem>
                  Les personnes autorisées travaillant pour le compte de la mission interministérielle pour
                  l’apprentissage dans le cadre de la conception des services numériques ;
                </ListItem>
                <ListItem>
            ...
            <Section mt={4} id={currentPage.anchors.SecuriteEtConfidentialiteDesDonnees}>
              ...
              <Text>
                ...
                <br />
                <br />
                Le site ne dépose pas de cookies de mesure d’audience (nombre de visites, pages consultées). Néanmoins,
                nous utilisons Plausible qui permet de suivre les tendances d’utilisation de notre site. L’outil ne
                permet pas d’identifier les personnes, ni de tracer votre usage d’internet, dans ou en dehors du site.
                <br />
                <br />
