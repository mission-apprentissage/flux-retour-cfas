  ...
  const transformedData = data.reduce(
    (acc, { stats }) => {
      return {
        ...
        injoignables: (stats.injoignables || 0) + (acc.injoignables || 0),
      ...
      series={[
        {
          ...
          data: [
            ...
            {
              id: 4,
              value: transformedData.injoignables,
              label: "Injoignables",
              labelMarkType: "square",
              color: "#FF6B6B",
            },
            ...
            { id: 6, value: transformedData.autre, label: "Autre", labelMarkType: "square", color: "#A78BCC" },
          ],
        },
      ]}
      sx={{
...
const TableauARMLTraite = ({ data }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      { label: "Injoignables", dataKey: "injoignables", width: 100, sortable: false },
