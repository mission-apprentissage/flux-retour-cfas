...
export const usersExportColumns = [
  ...
  { label: "ml_code_departement", key: "ml_code_departement", width: 15, xlsxType: "string" },
  { label: "ml_nom_departement", key: "ml_nom_departement", width: 25 },
  { label: "ml_nom_region", key: "ml_nom_region", width: 25 },
