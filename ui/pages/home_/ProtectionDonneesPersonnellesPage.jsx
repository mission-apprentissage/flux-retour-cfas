        ...
        <HStack spacing="12w">
          ...
          <Box>
            ...
            <Section id={currentPage.anchors.missionInteretPublic} marginTop="5w">
              ...
              <Box marginTop="1w">
                ...
                <Text fontSize="epsilon" color="grey.800">
                  ...
                  Houzel fait l’objet de deux lettres en date du 10 septembre 2019 puis du 25 février 2020, mais aussi
                  de deux décisions du gouvernement en date du 26 novembre 2019 et du 15 octobre 2020.
                </Text>
              </Box>
            </Section>
            ...
            <Section id={currentPage.anchors.faciliterPilotage} mt="10w">
              ...
              <Box marginTop="1w">
                <Text fontSize="epsilon" color="grey.800">
                  Le {PRODUCT_NAME} vise à mettre à disposition de toutes les parties prenantes de la formation en
                  apprentissage les données clés, de manière dynamique, afin de permettre un pilotage opérationnel
            ...
            <Section id={currentPage.anchors.minimisationDonnees} mt="10w">
              ...
              <Box marginTop="1w" marginBottom="15w">
                <Text marginBottom="2w" fontSize="epsilon" color="grey.800">
                  Dans le respect du RGPD, seules les données utiles à la construction du {PRODUCT_NAME}
                  sont collectées.
                </Text>
                <Text fontSize="epsilon" color="grey.800">
