...
export default ({ mailer }) => {
  ...
  router.post(
    ...
    tryCatch(async ({ body }, res) => {
      ...
      try {
        // TODO [tech] send email to user
        // await mailer.sendEmail(user.email, `[${config.env} Contrat publique apprentissage] Bienvenue`, "greetings", {
        ...
        throw Boom.internal(`Unable to send greetings email`);
      }
    })
  );
