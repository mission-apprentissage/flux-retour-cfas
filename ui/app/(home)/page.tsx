                          ...
                          <div className="fr-modal__content">
                            ...
                            <div>
                              <p>
                                ...
                                relations réseau et partenaires à la Mission Locale Technowest Nouvelle-Aquitaine, et
                                Carole HyrezaResponsable du pôle entreprises et anticipations des mutations économiques
                                à la Mission LocaleInsertion Formation Emploi du Grand Amiénois nous ont partagé les
                                difficultés rencontréespour repérer les jeunes en rupture de contrat d’apprentissage.
                              </p>
                              <p>
                                Elle partage le même constat : notre service numérique permet principalement
                                d’identifier des jeunes en ruptureque la Mission locale ne connaît pas encore.Il y a
                                beaucoup de jeunes qu&apos;on connaissait,mais on n&apos;avait pas forcément eu
                                l&apos;informationqui nous disait que ce jeune avait rompu,parce que pour certains, là
                                le dernier c&apos;était novembreon est aujourd&apos;hui le 29 avril,donc voilà,
                                c&apos;est cette information làet à peu près 75%sur cette liste de 215, ce sont des
                                jeunesqui ne connaissaient pas la Mission Locale a priori,puisqu&apos;en fait il
                                n&apos;était pas dans notre base de données.
                              </p>
                              <p>
                                Mais on a également accès aux jeunes rupturantsqui ne connaissent pas forcément la
                                Mission Localeou qui n&apos;ont jamais été inscrits à la Mission Locale.Et de ce fait,
                                ça nous permet de prendre contact avec euxet de leur proposer un accompagnement Mission
                                Locale pour les aiderdans leur recherche d&apos;un nouveau contrat.
                              </p>
                              <p>
                                Au-delà de ce repérage,Thibaut Clery, Référent Formation et Alternanceà la Mission
                                Locale du Beauvaisis,mentionne un autre avantage de notre service numérique,celui de
                                multiplier les interactions avec les CFA.C&apos;était d&apos;abord de peut-être beaucoup
                                plus interagir,en tout cas facilement avec un certain nombre de CFA.Ça démultiplie les
                                échanges en tout cas avec les CFA pour dire :« Bah tiens, j&apos;ai ce jeune là qui
                                apparaît,qu&apos;est-ce que tu en penses ? Où est-ce qu&apos;on en est ? »Lui allumer la
                                lumière en disant :« N&apos;oublie pas de nous l&apos;orienter au cas où. »Ça permet de
                                rappeler aussi les bonnes pratiquesqu&apos;on utilise avec un certain nombre de CFA.Donc
                                ça, c&apos;est vraiment un plus pour nous.
                              </p>
                              <p>
                                À la question :« Recommanderiez-vous notre service public numérique ? »la réponse est
                                unanime : oui.Plébiscité pour sa facilité d’utilisation et son utilitédans
                                l’accompagnement des jeunes,notre service a convaincu les Missions Locales qui l’ont
                                expérimenté.Cette expérience positive les conduit aujourd’huià envisager un engagement à
                                long termedans le déploiement du service.
                              </p>
                              <p>
                                Je vais être directe avec vous,nous on souhaite continuer en tout cas
                                l&apos;expérimentationet continuer la démarche avec vous.Même si au début, quand on a
                                commencé l&apos;expérimentation,on s&apos;est retrouvé avec 150 jeunes à contacter,ça
                                nous a un peu semblé beaucoup sur le moment.Mais finalement, on a trouvé une
                                organisation, une articulationqui nous a permis de contacter tous les jeuneset puis
                                d&apos;obtenir des rendez-vous.
                              </p>
                              <p>
                                Je recommande vivementet j&apos;ai déjà recommandé à mon collèguequi n&apos;est pas très
                                loin et qui est entré dans l&apos;expérimentation il y a 3 semaines.Donc oui je pense
                                que c&apos;est un outil qu&apos;il faut généraliser certes,après il y a peut-être des
                                Missions Localesqui n&apos;auront pas forcément le tempsou les moyens humains de pouvoir
                                le gérer.Comme je disais, il faut y aller tous les 2-3 jours,ça se met à jour
                                régulièrement doncpour être réactif au niveau des jeunesil faut quand même qu&apos;on
                                ait l&apos;information assez tôt,dès sa rupture de contratil faut qu&apos;on aille le
                                plus vite possible pour pouvoir le raccrocher.
                              </p>
                              <p>
