  ...
  await Promise.all(
    schemas
      ...
      .map(async ({ schema, collectionName }) => {
        ...
        console.log((!schema ? "-" : "OK").padEnd(4), collectionName.padEnd(30), " > ", destination);
        ...
        if (!fs.existsSync(destination) || fs.readFileSync(destination, "utf8").includes("auto-generated")) {
