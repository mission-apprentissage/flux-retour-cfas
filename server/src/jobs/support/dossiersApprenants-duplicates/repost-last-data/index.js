 ...
 * FLUX_RETOUR_CFAS_REPOST_JOB_USERNAME_XXXX FLUX_RETOUR_CFAS_REPOST_JOB_PASSWORD_XXXX et pour chaque ERP ou XXXX = username
 */

/**
 * Cette fonction envoi sur l'API souhaitée l'ensemble des derniers statuts recus la veille
 */
export const repostLastReceivedDossiersApprenantsToEnv = async () => {
  // Récupération des usersEvents de la veille
  const lastUserEventsReceived = await userEventsDb().find({
