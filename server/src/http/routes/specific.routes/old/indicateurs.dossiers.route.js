...
export default ({ effectifsFromDossiers, cache }) => {
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const response = {
          date,
          apprentis: await effectifsFromDossiers.apprentis.getCountAtDate(date, filters),
          rupturants: await effectifsFromDossiers.rupturants.getCountAtDate(date, filters),
          inscritsSansContrat: await effectifsFromDossiers.inscritsSansContrats.getCountAtDate(date, filters),
          abandons: await effectifsFromDossiers.abandons.getCountAtDate(date, filters),
        };
        // cache the result
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsParNiveauFormation = await effectifsFromDossiers.getEffectifsCountByNiveauFormationAtDate(
          date,
          filters
        );
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsParFormation = await effectifsFromDossiers.getEffectifsCountByFormationAtDate(date, filters);
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsParAnneeFormation = await effectifsFromDossiers.getEffectifsCountByAnneeFormationAtDate(
          date,
          filters
        );
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsByCfaAtDate = await effectifsFromDossiers.getEffectifsCountByCfaAtDate(date, filters);
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsBySiretAtDate = await effectifsFromDossiers.getEffectifsCountBySiretAtDate(date, filters);
  ...
  router.get(
    ...
    tryCatch(async (req, res) => {
      ...
      if (fromCache) {
        ...
        const effectifsByDepartementAtDate = await effectifsFromDossiers.getEffectifsCountByDepartementAtDate(
          date,
          filters
        );
