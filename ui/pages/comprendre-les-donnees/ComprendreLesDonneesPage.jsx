...
const ComprendreLesDonneesPage = () => {
  return (
    <Page>
      <Section withShadow>
        <Box paddingTop="3w">
          <BreadcrumbNav links={[NAVIGATION_PAGES.Accueil, NAVIGATION_PAGES.ComprendreLesDonnees]} />
        </Box>
      </Section>
      <Section color="grey.800" marginTop="5w" marginBottom="10w">
        <Flex>
          <Sommaire>
          ...
          <Box marginLeft="10w" width="65%">
            ...
            <Box marginTop="5w">
              ...
              <Text>
                ...
                périmètre géographique. La fin du déploiement est prévue d&apos;ici la fin de l&apos;année.
              </Text>
            </Box>
            <Box marginTop="10w">
              ...
              <Text>
                ‌A ce jour, Yparéo nous transmet les données de manière quotidienne et Gesti chaque lundi. De fait, les
                données sont constamment rafraîchies. ‌Lorsque vous consultez le mois en cours, les effectifs affichés
                sont ceux du dernier jour disponible, par exemple si le 12 janvier 2021, vous sélectionnez la période
                &quot;janvier 2021&quot; , vous pourrez connaître les effectifs comptabilisés au 12 janvier. ‌Lorsque
                vous sélectionnez un mois antérieur, les effectifs affichés sont une photographie &quot;fin de
                mois&quot;, c&apos;est-à-dire au dernier jour du mois consulté. Par exemple, si toujours le 12 janvier
                2021, vous sélectionnez la période &quot;décembre 2019, vous pourrez connaître les effectifs
            ...
            <Box marginTop="5w">
              ...
              <Text>
                ...
                (d&apos;Apprenti à Abandon, par exemple) mais nous ne faisons aucun traitement statistique. ‌Les données
                exposées correspondent aux effectifs des CFA en temps réel. De ce fait, lorsqu&apos;un établissement
                enregistre une information dans son Système d&apos;Information (Inscription, Nouveau Contrat...)
                l&apos;information est restituée le lendemain ou la semaine suivante au plus tard (Gesti) dans le{" "}
                {PRODUCT_NAME}.
              </Text>
            </Box>
          </Box>
