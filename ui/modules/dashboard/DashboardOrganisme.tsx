...
export function getForbiddenErrorText(ctx: AuthContext): string {
  ...
  switch (organisation.type) {
    ...
    case "ORGANISME_FORMATION_RESPONSABLE_FORMATEUR":
      return "Vous n’avez pas accès aux données détaillées de cet organisme.";

    case "TETE_DE_RESEAU":
      return "Vous n’avez pas accès aux données détaillées de cet organisme car il n’est pas dans votre réseau.";

    case "DREETS":
    case "DRAAF":
    case "CONSEIL_REGIONAL":
      return "Vous n’avez pas accès aux données détaillées de cet organisme car il n’est pas dans votre région.";
    case "DDETS":
      return "Vous n’avez pas accès aux données détaillées de cet organisme car il n’est pas dans votre département.";
    case "ACADEMIE":
      return "Vous n’avez pas accès aux données détaillées de cet organisme car il n’est pas dans votre académie.";
  }
  return "";
}
