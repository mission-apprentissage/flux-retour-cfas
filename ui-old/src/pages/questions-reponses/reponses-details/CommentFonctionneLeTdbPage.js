          ...
          AccordionItemsDetailList={[
            ...
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Pour simplifier les démarches de collecte de données, qui étaient auparavant effectuées par chacune
                    des administrations (Académie, DREETS, DRAAF, Carif Oref, etc), le Tableau de bord agrège les
                    données depuis les ERP des établissements de formation. les données utiles directement via l’ERP de
                    l’établissement.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    L’équipe du Tableau de bord travaille à une solution pour que les établissements non équipés d’un
                    ERP interfaçable, puissent déposer les données utiles. Cette solution sera disponible gratuitement
                    sur le site du Tableau de bord, au quatrième trimestre 2022.
                    <br />
                    <br />
            ...
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Le Tableau de bord est un produit de la Mission Nationale pour le développement de l’Apprentissage,
                    qui est incubée au sein de beta.gouv.
                    <br />
                    <br />
                    L’équipe du Tableau de bord est organisée selon les principes de l’Agilité, elle fait évoluer le
                    produit Tableau de bord en fonction des besoins des utilisateurs par cycles courts, elle délivre de
                    la valeur ou de nouvelles fonctionnalités à chaque itération. Cela permet de rester aligné avec les
                    besoins réels de visibilité sur les chiffres clés de l’apprentissage, des usages des organismes de
                    formation et la capacité de développement.
                    <br />
                    <br />
          ...
          AccordionItemsDetailList={[
                ...
                <Box>
                  <UnorderedList marginLeft="3w">
                    <ListItem>
                      ...
                      simple paramétrage suffit pour vous brancher au Tableau de Bord. La démarche n’est à faire qu’une
                      seule fois et est estimée à 10 minutes. Pour ce faire, [sélectionner l’ERP que vous utilisez] et
                      téléchargez le pas à pas correspondant :{" "}
                      <Link
                        to="/organisme-formation/transmettre"
                        as={NavLink}
                        color="bluefrance"
                    ...
                    <ListItem>
                      ...
                      publics, celle-ci vous sera proposée dès le quatrième trimestre 2022. Nous avons besoin
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    <br />
                    <br />
                    Si vous avez un ERP interfaçé avec le Tableau de bord, le paramétrage prend une dizaine de minutes,
                    vous n’avez pas à renouveler l’opération, sauf si vous changez d’UAI, de SIRET ou d’ERP. Pour en
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    publiques ont accès aux données. Dans le cadre de la mission publique que vous exercez en
                    administrant la formation en apprentissage, vous avez une obligation légale de donner de la
                    visibilité aux administrations concernées.
                    <br />
                    <br />
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    Nationale pour enregistrer un organisme dans le Répertoire National des Etablissements (RNE). Elle
                    est composée de sept chiffres et une lettre.
                    <br />
                    <br />
              ...
              content: (
                <Box>
                  <Text>
                    Non !
                    <br />
                    Vos données ne peuvent être consultées que par votre organisme et par les administrations publiques
                    dans le cadre de la politique de l’apprentissage.
                  </Text>
                </Box>
              ),
            },
            ...
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Les données de votre organisme s’affichent si vous avez autorisé votre ERP (ou logiciel de gestion)
                    à transmettre vos données au Tableau de bord de l’apprentissage ou si vous avez transmis via le
                    service partage simplifié.
                    <br />
                    <br />
            ...
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Toutes les données que vous transmettez sont accessibles via votre URL privée. Vous avez également
                    la possibilité de télécharger ces données en fichier XLS.
                  </Text>
                </Box>
              ),
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Nous avons actuellement plusieurs travaux et recherches en cours afin d’améliorer le Tableau de bord
                    et les fonctionnalités à disposition. Si vous souhaitez y participer ou nous faire un retour, vous
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    <br />
                    <br />
                    Ces données ne sont pas transformées, elles sont agrégées afin d’identifier le nombre d’apprentis
                    par niveau et code diplôme, les inscrits sans contrats, les rupturants et les abandons.
                    <br />
                    <br />
            ...
            },
            {
              ...
              content: (
                <Box>
                  <Text>
                    Vous pouvez consultez vos données via une URL privée dont le lien se trouve directement dans votre
                    ERP. Pour les utilisateurs de Partage Simplifié (le service du Tableau de bord vous permettant de
                    transmettre vos données sans utiliser un ERP) cette URL vous sera communiquée après la première
                    transmission d’un fichier.
                    <br />
                    <br />
                    Si toutefois vous n’aviez pas reçu ou n’aviez pas accès à cette URL, vous pouvez en faire la demande
                    en contactant l’équipe du Tableau de bord par courriel :{" "}
                    <Link href={`mailto:${CONTACT_ADDRESS}`} color="bluefrance" whiteSpace="nowrap">
                      {CONTACT_ADDRESS}
                    </Link>{" "}
              ...
              content: (
                <Box>
                  ...
                  <UnorderedList marginLeft="3w">
                    ...
                    <ListItem>
                      Les réseaux d’organismes de formation constitués, comme par exemple les CMA, les CCI, les MFR ou
                      bien encore Excellence pro ou CGE (conférence des grandes écoles);
                    </ListItem>
                    <ListItem>
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    produit. À ce jour, outre les chiffres clés de l’apprentissage, le Tableau de bord est en capacité
                    de fournir aux institutions publiques un certain nombre de données sur l’apprentissage. Plusieurs
                    régions ont entamé des expérimentations afin d’accompagner les jeunes en situation de décrochage
                    scolaire à partir des données fournie par le {PRODUCT_NAME} .
                  </Text>
                </Box>
              ),
            },
              ...
              content: (
                <Box>
                  <Text>
                    ...
                    <br />
                    <br />
                    En parallèle, l’équipe Tableau de bord développe actuellement une interface pour vous permettre de
                    nous remonter facilement vos demandes d’évolutions, corrections. Grâce à votre expertise de terrain,
                    vous pourrez ainsi directement nous accompagner à la fiabilisation de la donnée.
                  </Text>
                </Box>
              ),
            },
