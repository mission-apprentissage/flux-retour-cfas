...
interface OrganismeFiltersListVisibilityProps {
...
const OrganismesFilterAndSearchPanel = (props: OrganismeFiltersListVisibilityProps) => {
...
export default OrganismesFilterAndSearchPanel;
