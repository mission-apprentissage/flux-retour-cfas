import { Alert, AlertIcon, Box, HStack, Stack, Text } from "@chakra-ui/react";
      ...
      <>
        <Box>
          ...
          <HStack spacing="2w" mt="3w">
            ...
            <StatCard
              background="info"
              label="Candidats multi-UAIs avec INE"
              stat={stats.nbCandidatsMultiUaisWithIne}
            />
            <StatCard
              background="info"
            ...
            <StatCard
              background="info"
              label="Candidats multi-CFDs avec INE"
              stat={stats.nbCandidatsMultiCfdsWithIne}
            />
            <StatCard
              background="info"
