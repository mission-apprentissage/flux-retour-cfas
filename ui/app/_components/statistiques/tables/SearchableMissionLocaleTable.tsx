...
interface SearchableMissionLocaleTableProps {
  period: StatsPeriod;
  search: string;
}

export function SearchableMissionLocaleTable({ period, search }: SearchableMissionLocaleTableProps) {
  ...
  }, [data, isLoading, page, period, limit, sortColumn, sortDirection, prefetchNextPage, search, isSearching]);
