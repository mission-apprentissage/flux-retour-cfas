  ...
  authRouter.use(
    ...
    express
      ...
      .get(
        ...
        returnResult(async (req, res) => {
          const { pageIndex, pageSize, search, sortField, sortOrder, ...filters } = req.query;
          ...
          return await getOrganismeEffectifs(res.locals.organismeId, req.query.sifa === "true", options);
        })
      )
      .put(
        "/effectifs",
