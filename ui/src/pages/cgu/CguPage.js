...
import { BreadcrumbNav, Page, Section } from "../../common/components/index.js";
import Sommaire from "../../common/components/Sommaire/Sommaire.js";
...
export const CguPage = () => {
  ...
  return (
    <Page>
      <Section withShadow>
        <Box paddingTop="3w">
          <BreadcrumbNav links={[NAVIGATION_PAGES.Accueil, NAVIGATION_PAGES.CGU]} />
        </Box>
      </Section>
      <Section>
        <HStack
          ...
          <Box>
            ...
            <Section mt={4} id={currentPage.anchors.Definition}>
              ...
              <Text>
                ...
                <br />
                <br />
                <strong>« Services »</strong> : ensemble des prestations proposées sur le Tableau de bord. Elles sont
                les suivantes : création d&apos;un compte utilisateur, consultation des données, export des données,
                saisie de données, accès à la documentation.
                <br />
                <br />
            ...
            <Section mt={4} id={currentPage.anchors.FonctionnaliteLieesAuxComptesDesUtilisateurs}>
              ...
              <Text>
                ...
                profil et d&apos;accéder aux fonctionnalités de consultation de certaines données, d’export des données
                et de saisie de données.
                <br />
                <br />
                L&apos;utilisateur est titulaire d&apos;un compte personnel, accessible par son identifiant personnel et
                par un mot de passe dès lors que toutes les formalités nécessaires à son inscription sont accomplies.
                <br />
                <br />
                ...
                oubli de mot de passe » et suit les instructions fournies par le Tableau de bord.
              </Text>
            </Section>
            <Section mt={4} id={currentPage.anchors.PresentationDesServices}>
              ...
              <Text>
                ...
                <br />
                <br />
                La Mission interministérielle de l’apprentissage se réserve le droit, sans préavis, ni indemnité, de
                fermer temporairement l&apos;accès à un ou plusieurs services du Tableau de bord pour effectuer une mise
                à jour, des modifications ou changements sur les méthodes opérationnelles, les serveurs et les heures
            ...
            <Section mt={4} id={currentPage.anchors.Securite}>
              ...
              <Text>
                ...
                fonctionnement de ce système, ou en cas d&apos;introduction, de suppression ou de modification des
                données qui y sont contenues.
                <br />
                <br />
                L&apos;utilisateur s&apos;engage à ne pas perturber le bon fonctionnement de ce système. Il veille
                notamment à ne pas introduire de virus ou toute autre technologie nuisible au Tableau de bord.
                <br />
                <br />
            ...
            <Section mt={4} id={currentPage.anchors.Hyperliens}>
              ...
              <Text>
                La Mission interministérielle de l’apprentissage se réserve la possibilité de mettre en place des
                hyperliens sur le Tableau de bord donnant accès à des pages internet autres que celles de son interface.
                <br />
                <br />
            ...
            <Section mt={4} id={currentPage.anchors.Responsabilites}>
              ...
              <Text>
                ...
                services du Tableau de bord. La Mission interministérielle de l’apprentissage ne saurait être
                responsable de l&apos;impossibilité d&apos;utiliser le Tableau de bord et les services.
                <br />
                <br />
                La Mission interministérielle de l’apprentissage ne saurait être responsable des atteintes à la sécurité
                informatique pouvant causer des dommages aux matériels informatiques des utilisateurs et à leurs
                données.
                <br />
                <br />
                ...
                <br />
                <br />
                La responsabilité de la Mission interministérielle de l’apprentissage ne pourra être recherchée ni
                retenue en cas d&apos;indisponibilité temporaire ou totale de tout ou partie de l&apos;accès au Tableau
                de bord, d&apos;une difficulté liée au temps de réponse et d&apos;une manière générale, d&apos;un défaut
                de performance quelconque.
              </Text>
              <br />
              ...
              <Text>
                <br />
                L&apos;utilisateur s&apos;engage à utiliser le Tableau de bord et les services, ainsi que
                l&apos;ensemble des informations auxquelles il pourra avoir accès en conformité avec les stipulations
                des présentes conditions générales d&apos;utilisation.
                <br />
                <br />
                L&apos;utilisateur est seul responsable de la préservation et de la confidentialité de son mot de passe
                et autres données confidentielles qui lui seraient éventuellement transmises par la Mission
                interministérielle de l’apprentissage.
                <br />
                <br />
                L&apos;utilisateur est responsable de la sincérité des informations qu&apos;il fournit et s&apos;engage
                à mettre à jour les informations le concernant ou à aviser la Mission interministérielle de
                l’apprentissage sans délai de toute modification affectant sa situation.
                <br />
                <br />
                En cas d&apos;utilisation frauduleuse de son compte ou vol de son mot de passe, l&apos;utilisateur
                s&apos;engage à prévenir immédiatement la Mission interministérielle de l’apprentissage et à modifier
                ...
                auxquelles il pourra avoir accès, dans un but conforme à l&apos;ordre public, aux bonnes mœurs et aux
                droits des tiers.
                <br />
                <br />
                L&apos;utilisateur s&apos;engage à ne commettre aucun acte pouvant mettre en cause la sécurité
                informatique de la Mission interministérielle de l’apprentissage ou des autres utilisateurs.
                <br />
                <br />
                L&apos;utilisateur s&apos;engage à ne pas interférer ou interrompre le fonctionnement normal du Tableau
                de bord.
                <br />
                <br />
                ...
                <br />
                <br />
                L&apos;Utilisateur s&apos;engage à ne pas commercialiser les données reçues et à ne pas les communiquer
                à des tiers en dehors des cas prévus par la loi.
                <br />
                <br />
                ...
                <br />
                <br />
                Toute tentative d&apos;accès non autorisé aux services, à d&apos;autres comptes, aux systèmes
                informatiques ou à d&apos;autres réseaux connectés ou à l&apos;un des services via le piratage ou toute
                autre méthode est interdite.
              </Text>
            </Section>
            <Section mt={4} id={currentPage.anchors.MiseAjourDesConditionsUtilisation}>
              ...
              <Text>
                Les termes des CGU doivent être acceptés au moment de la connexion. Toute modification des CGU réalisée
                en fonction des modifications apportées au site, de l’évolution de la législation ou pour tout autre
