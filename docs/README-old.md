...
Ce repository contient l'application du produit Tableau de bord.

## Infrastructure & Déploiement

Ce projet fonctionne de manière autonome en local avec des conteneurs docker en services.

Pour déployer et faire fonctionner l'application sur un server dédié dans OVH.
