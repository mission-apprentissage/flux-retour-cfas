...
export default function CampagneMissionLocaleClient({ token }: { token: string }) {
  ...
  return (
    <Stack spacing={3} sx={{ width: "100%" }}>
      ...
      <Typography>
        Être accompagné(e) par la Mission Locale {data?.missionLocale?.nom}, c&apos;est bénéficier d&apos;un
        accompagnement personnalisé, de proximité et profiter d&apos;un réseau de partenaires !
      </Typography>
