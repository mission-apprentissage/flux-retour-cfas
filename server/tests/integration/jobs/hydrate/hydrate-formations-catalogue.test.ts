...
import { ObjectId, EnhancedOmit } from "mongodb";
...
declare type WithStringId<TSchema> = EnhancedOmit<TSchema, "_id"> & {
  _id: string;
};
  ...
  const formationsCatalogueCompletes: WithStringId<any>[] = [
    {
      ...
      etablissement_gestionnaire_num_academie: "04",
      ...
      etablissement_formateur_num_academie: "04",
